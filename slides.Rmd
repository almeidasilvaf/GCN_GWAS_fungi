...
Produção de alimentos deve aumentar em 50% até 2030 .font80[(Hartman et al., 2014)]


Desafio: desperdício de alimentos .font80[(FAO, 2014)]


Bilhões de dólares gastos anualmente no controle de pragas e doenças .font80[(Osman et al., 2015)]


Agrotóxicos: danos ambientais e à saúde


Aumento sustentável na produtividade .font80[(FAO, 2014)]

]

---

background-image: url(figs/intro2.png)
background-position: 95% 50%
background-size: 45%
...
**Estresse biótico:** patógenos (fungos, bactérias, vírus e parasitas) e pragas (insetos)

Perda de produtividade por:
